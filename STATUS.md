...
**Status:** active
**Phase:** v3.0 — AEGIS-CONTEXT-01 shipped, AEGIS-SNIPER-01 next
**Last Sprint:** AEGIS-CONTEXT-01
**Last Updated:** 2026-03-24
**Completion:** v2 92% / v3 50%
...
- [x] **[P0]** AEGIS-MONITOR-01: Extended monitoring — disk I/O delta, SMART health,
      network per-adapter, GPU, DPC/interrupt, spawn tree, hard fault rate (f88a926, 2026-03-24)
- [x] **[P1]** AEGIS-CONTEXT-01: Context detection engine — WinEvent hooks, foreground
      tracking, named contexts, composable policy layer replacing profiles (2026-03-24)
